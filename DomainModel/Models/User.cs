...
#nullable disable
        ...
        /// <summary>Determines whether [is valid account type] [the specified account type].</summary>
        /// <param name="accountType">The account type.</param>
        /// <param name="context">The context.</param>
        /// <returns>
        ///    <see cref="ValidationResult.Success"/> if the account type is a valid account type.
        ///    <br/>
        ///    <see cref="ValidationResult(string?)"/> if the account type is not a valid account type.
        /// </returns>
