...
namespace AuctionConsoleApp
{
    ...
    public class AuctionManager
    {
        ...
        public List<Product> GetProducts()
        {
            ...
            {
                new Product("Laptop ultraportabil Lenovo IdeaPad 5 Pro 14ACN6", "procesor AMD Ryzen™ 5 5600U, 14\", 2.8K, 90Hz, 16GB, 1TB SSD, AMD Radeon Graphics, No OS, Cloud Grey", this.categoryServices.GetCategoryByName("Laptopuri"), 2999.99m, ECurrency.RON, this.userServices.GetUserById(1), DateTime.Today, DateTime.Today.AddDays(30)),
                new Product("Laptop ultraportabil HP 240 G8", "procesor Intel Core i3-1005G1, 14\", HD, 8GB, 256GB SSD, Intel UHD Graphics, Free DOS, Dark Ash Silver", this.categoryServices.GetCategoryByName("Laptopuri"), 299.99m, ECurrency.EUR, this.userServices.GetUserById(2), DateTime.Today, DateTime.Today.AddDays(30)),
                new Product("Laptop ASUS X515EA", "procesor Intel® Core™ i5-1135G7, 15.6\", Full HD, 8GB, 512GB SSD, Intel Iris Xᵉ Graphics, No OS, Slate grey", this.categoryServices.GetCategoryByName("Laptopuri"), 2349m, ECurrency.RON, this.userServices.GetUserById(2), DateTime.Today, DateTime.Today.AddDays(30)),
                new Product("Laptop ultraportabil Dell Latitude 3410", "procesor Intel Celeron 5205U, 14\" Full HD, Memorie RAM 4GB DDR4, Stocare 128GB SSD, Intel UHD Graphics, Windows 10 Pro, Grey", this.categoryServices.GetCategoryByName("Laptopuri"), 2349.99m, ECurrency.RON, this.userServices.GetUserById(2), DateTime.Today, DateTime.Today.AddDays(30)),
            };
        }
