...
namespace ServiceLayer.Implementation
{
    ...
    public class ProductServicesImplementation : IProductServices
    {
        ...
        public bool AddProduct(Product product)
        {
            ...
            // Check if <user> can create new auction.
            if (this.productDataServices.GetNoOfActiveAndFutureAuctionsByUserId(product.Seller.Id)
                >= this.userScoreAndLimitsDataServices.GetUserLimitByUserId(product.Seller.Id))
            {
                this.logger.Warn("Attempted to create too many auctions.");
                return false;
            }

            // Check if <user> can create new active auction.
            ...
            // Check if <user> can create new active auction in <category>.
            ...
            // Check if <product description> is not to similar to other product descriptions.
            ...
            // If all checks pass call AddProduct.
        ...
        public bool UpdateProduct(Product product)
        {
            ...
            // If all checks pass call UpdateProduct.
        ...
        public bool DeleteProduct(Product product)
        {
            ...
            // If all checks pass call DeleteProduct.
