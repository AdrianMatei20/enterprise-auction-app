...
namespace ModelValidationTests
{
    ...
    internal class UserValidation
    {
        ...
        /// <summary>Determines whether the given user is valid or not.</summary>
        /// <param name="user">The user.</param>
        /// <returns><b>true</b> if the given user is valid; otherwise, <b>false</b>.</returns>
        ...
        /// <summary>Creates a valid <see cref="User"/> object to be used for testing.</summary>
        [SetUp]
        public void SetUp()
        {
