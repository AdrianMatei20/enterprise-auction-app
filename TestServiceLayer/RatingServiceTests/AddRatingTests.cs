...
namespace RatingServiceTests
{
    ...
    internal class AddRatingTests
    {
        ...
        private const string LogAddRatingOnActiveAuction = "Attempted to add rating on an active auction.";
        ...
        public void ADD_ValidRating_ValidProduct_ValidSeller_PhoneNumber_Null()
        {
            ...
            ratingUserMock.SetupGet(x => x.AccountType).Returns(EAccountType.Buyer);
            ...
            ratedUserMock.SetupGet(x => x.AccountType).Returns(EAccountType.Seller);
        ...
        public void ADD_ValidRating_SellerRatingHimself()
        {
            ...
            buyerMock.SetupGet(x => x.AccountType).Returns(EAccountType.Buyer);
            ...
            randomUserMock.SetupGet(x => x.AccountType).Returns(EAccountType.Buyer);
