...
namespace BidServiceTests
{
    ...
    internal class AddBidTests
    {
        ...
        private const string LogAddEarlyOrLateBid = "Attempted to bid before the auction started or after the auction ended.";
        ...
        public void ADD_ValidBid_ValidProduct_ValidSeller_PhoneNumber_Null()
        {
            ...
            var productMock = new Mock<Product>("Aparat foto CANNON", "face poze", new Category("Aparat foto", null), 100m, ECurrency.EUR, new User("Dinu", "Garbuz", "GbDinu", "9876543210", "dinu.garbuz@FakeEmail.com", "P@rola123"), DateTime.Today.AddDays(-5), DateTime.Today.AddDays(5));
        ...
        public void ADD_ValidBid_ValidBuyer_PhoneNumber_Null()
        {
            ...
            sellerMock.SetupGet(x => x.Email).Returns("dinu.garbuz@FakeEmail.com");
            sellerMock.SetupGet(x => x.Password).Returns("P@rola123");
            sellerMock.SetupGet(x => x.AccountType).Returns(EAccountType.Seller);
            ...
            buyer1Mock.SetupGet(x => x.Email).Returns("andrei.costrache@FakeEmail.com");
            buyer1Mock.SetupGet(x => x.Password).Returns("@AbCd123");
            buyer1Mock.SetupGet(x => x.AccountType).Returns(EAccountType.Seller);
            ...
            buyer2Mock.SetupGet(x => x.Email).Returns("adrian.matei@FakeEmail.com");
            buyer2Mock.SetupGet(x => x.Password).Returns("P@ssword123");
            buyer2Mock.SetupGet(x => x.AccountType).Returns(EAccountType.Seller);
        ...
        /// <summary>
        ///     Test for adding an invalid bid (bid with buyer account type unknown).
        /// </summary>
        [Test]
        ...
        public void ADD_ValidBid_WrongCurrency()
        {
            ...
            buyerMock.SetupGet(x => x.AccountType).Returns(EAccountType.Seller);
        ...
        public void ADD_ValidBid()
        {
            ...
            buyer1Mock.SetupGet(x => x.Email).Returns("andrei.costrache@FakeEmail.com");
            buyer1Mock.SetupGet(x => x.Password).Returns("@AbCd123");
            buyer1Mock.SetupGet(x => x.AccountType).Returns(EAccountType.Buyer);
            ...
            buyer2Mock.SetupGet(x => x.Email).Returns("adrian.matei@FakeEmail.com");
            buyer2Mock.SetupGet(x => x.Password).Returns("P@ssword123");
            buyer2Mock.SetupGet(x => x.AccountType).Returns(EAccountType.Buyer);
